...
// 特定模块的便捷宏
#define LOG_BATTERY_ERROR(...)   LOG_ERROR(LOG_MODULE_BATTERY, __VA_ARGS__)
#define LOG_BATTERY_WARN(...)    LOG_WARN(LOG_MODULE_BATTERY, __VA_ARGS__)
#define LOG_BATTERY_INFO(...)    LOG_INFO(LOG_MODULE_BATTERY, __VA_ARGS__)
#define LOG_BATTERY_DEBUG(...)   LOG_DEBUG(LOG_MODULE_BATTERY, __VA_ARGS__)
#define LOG_BATTERY_VERBOSE(...) LOG_VERBOSE(LOG_MODULE_BATTERY, __VA_ARGS__)

#define LOG_SLEEP_ERROR(...)   LOG_ERROR(LOG_MODULE_SLEEP, __VA_ARGS__)
#define LOG_SLEEP_WARN(...)    LOG_WARN(LOG_MODULE_SLEEP, __VA_ARGS__)
#define LOG_SLEEP_INFO(...)    LOG_INFO(LOG_MODULE_SLEEP, __VA_ARGS__)
#define LOG_SLEEP_DEBUG(...)   LOG_DEBUG(LOG_MODULE_SLEEP, __VA_ARGS__)
#define LOG_SLEEP_VERBOSE(...) LOG_VERBOSE(LOG_MODULE_SLEEP, __VA_ARGS__)

#define LOG_CONFIG_ERROR(...)   LOG_ERROR(LOG_MODULE_CONFIG, __VA_ARGS__)
#define LOG_CONFIG_WARN(...)    LOG_WARN(LOG_MODULE_CONFIG, __VA_ARGS__)
#define LOG_CONFIG_INFO(...)    LOG_INFO(LOG_MODULE_CONFIG, __VA_ARGS__)
#define LOG_CONFIG_DEBUG(...)   LOG_DEBUG(LOG_MODULE_CONFIG, __VA_ARGS__)
#define LOG_CONFIG_VERBOSE(...) LOG_VERBOSE(LOG_MODULE_CONFIG, __VA_ARGS__)
...
#define LOG_NETWORK_ERROR(...)   LOG_ERROR(LOG_MODULE_NETWORK, __VA_ARGS__)
#define LOG_NETWORK_WARN(...)    LOG_WARN(LOG_MODULE_NETWORK, __VA_ARGS__)
#define LOG_NETWORK_INFO(...)    LOG_INFO(LOG_MODULE_NETWORK, __VA_ARGS__)
#define LOG_NETWORK_DEBUG(...)   LOG_DEBUG(LOG_MODULE_NETWORK, __VA_ARGS__)
#define LOG_NETWORK_VERBOSE(...) LOG_VERBOSE(LOG_MODULE_NETWORK, __VA_ARGS__)

#define LOG_ALS_ERROR(...)   LOG_ERROR(LOG_MODULE_ALS, __VA_ARGS__)
#define LOG_ALS_WARN(...)    LOG_WARN(LOG_MODULE_ALS, __VA_ARGS__)
#define LOG_ALS_INFO(...)    LOG_INFO(LOG_MODULE_ALS, __VA_ARGS__)
#define LOG_ALS_DEBUG(...)   LOG_DEBUG(LOG_MODULE_ALS, __VA_ARGS__)
#define LOG_ALS_VERBOSE(...) LOG_VERBOSE(LOG_MODULE_ALS, __VA_ARGS__)
