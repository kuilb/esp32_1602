...
- Version: **1.0.2(10A008)**
- 发布日期: **2025/11/25**
- 概要: 重构WiFi配置处理并改进版本管理
### 更新内容
- 重构: 重构WiFi配网网页, 实现前后端分离
- 新功能: 配置WiFi的网页现在会显示信号和加密图标
- 新功能: 改进版本管理机制, 现在会自动生成版本信息文件并写入固件
- 新功能: 现在会在开机时显示构建信息
- 新功能: 添加多个SVG图标用于OTA更新和WiFi状态指示
